...
- Before using a derived note in an answer, enforce its `access_policy`. For `source_acl`, verify that the current user can open every source needed for the answer; repository access is not sufficient.
