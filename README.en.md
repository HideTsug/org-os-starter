...
- Never run automatically, from CI, or in exchange for features (that is rank abuse under GitHub's Acceptable Use Policies). Details: the "Support prompt" section of [AGENTS.md](AGENTS.md)
